    ...
    return (
        <div className='flex items-center justify-center min-h-screen bg-black'>
            <div className='bg-gray-900 bg-opacity-90 border border-gray-700 p-8 rounded-lg shadow-lg w-96'>
                <h2 className='text-2xl text-amber-50 font-bold text-center mb-6'>Register</h2>
                <form onSubmit={handleSubmit}>
                    <div className='mb-4'>
                        <label className='text-amber-50'>Name</label>
                        <input
                            type="text"
                            placeholder='Name'
                    ...
                    <div className='mb-4'>
                        <label className='text-amber-50'>Password</label>
                        <input
                            type="password"
